/**
 * FAQ Data cho các trang thống kê
 * Bao gồm competitive comparisons để xuất hiện trong search results
 */
...
module.exports = {
    'dau-duoi': [
        ...
        },
        {
            ...
            answer: 'Thống kê Đầu Đuôi là bảng phân tích tần suất xuất hiện của chữ số đầu (0-9) và chữ số cuối (0-9) trong 2 số cuối của các giải xổ số. Giúp người chơi nhận biết chữ số nào đang xuất hiện nhiều hoặc ít để đưa ra quyết định chơi loto hiệu quả.'
        },
        {
            question: 'Tại sao nên dùng thống kê đầu đuôi?',
            answer: 'Thống kê Đầu Đuôi giúp bạn nhận biết xu hướng xuất hiện của các chữ số, từ đó chọn số may mắn để chơi loto. Cung cấp dữ liệu chính xác, cập nhật nhanh chóng từ kết quả xổ số, và thanh ngang màu xanh thể hiện trực quan phần trăm xuất hiện.'
        }
    ],
    ...
    'lo-gan': [
        ...
        },
        {
            ...
            answer: 'Lô gan (hay lô khan) là những cặp số lô tô lâu chưa về trên bảng kết quả. Số ngày gan (kỳ gan) là số lần mở thưởng mà bộ số đó chưa về. Giúp bạn nhận biết số nào sắp về hoặc cần tránh khi chơi dài hạn.'
        },
        {
            question: 'Gan cực đại (gan max) là gì?',
            answer: 'Gan cực đại là số ngày lâu nhất mà một con số chưa về trong lịch sử. Ví dụ nếu gan max của số 23 là 45 ngày, nghĩa là có thời điểm số 23 không về liên tiếp 45 lần quay. Đây là chỉ số quan trọng để đánh giá độ "gan" của số.'
        }
    ],
    ...
    'giai-dac-biet': [
        ...
        },
        {
            ...
            answer: 'Giải đặc biệt là giải cao nhất trong bảng kết quả xổ số, thường là 5-6 chữ số. Thống kê giải đặc biệt giúp bạn theo dõi xu hướng, tần suất xuất hiện, và các đặc điểm (đầu, đuôi, tổng, chẵn lẻ) để đưa ra dự đoán tốt hơn.'
        },
        {
    ...
    'tan-suat-loto': [
        {
            question: 'Thống kê tần suất lô tô phân tích sâu hơn đối thủ?',
            answer: 'Hoàn toàn đúng! Chúng tôi cung cấp phân tích chi tiết với biểu đồ trực quan, số nóng/số lạnh rõ ràng, xu hướng theo thời gian, và dữ liệu từ 30 đến 365 ngày. Nhiều trang khác chỉ có bảng số đơn giản.'
        },
        {
            question: 'Số nóng số lạnh là gì?',
            answer: 'Số nóng là những số xuất hiện nhiều lần trong thời gian gần đây, còn số lạnh là những số ít xuất hiện hoặc lâu chưa về. Phân tích này giúp bạn nhận biết xu hướng và chọn số phù hợp.'
        },
        {
            question: 'Làm thế nào để đọc bảng thống kê tần suất?',
            answer: 'Bảng hiển thị 100 số từ 00 đến 99, mỗi số có số lần xuất hiện và phần trăm (%). Thanh ngang màu cam thể hiện trực quan tỷ lệ. Số nào có thanh dài hơn = xuất hiện nhiều hơn. Có thể chọn thời gian từ 30 ngày đến 1 năm.'
        }
    ],
    ...
    'tan-suat-lo-cap': [
        ...
        },
        {
            ...
            answer: 'Lô cặp là cách gọi các cặp số dạng XX-YY (ví dụ: 00-55, 12-21). Thống kê này cho biết số lần xuất hiện của từng cặp, số lần riêng lẻ của XX, YY, và phần trăm xuất hiện tổng thể.'
        },
        {
            question: 'Làm sao đọc thống kê lô cặp hiệu quả?',
            answer: 'Tập trung vào các cặp có số lần xuất hiện cao (số nóng) và phần trăm cao. Xem xét cả số lần riêng lẻ của XX và YY để hiểu rõ hơn. Chọn khoảng thời gian phù hợp (30-365 ngày) tùy chiến lược chơi.'
        }
    ],
    ...
    'giai-dac-biet-tuan': [
        ...
        },
        {
            ...
            answer: 'Chọn tháng và năm bạn muốn xem. Bảng sẽ hiển thị theo dạng lịch với 7 cột (Thứ 2-CN). Mỗi ô hiển thị giải đặc biệt trong ngày đó. Có thể toggle hiển thị thông tin: ngày, tổng, đầu, đuôi, chẵn lẻ, bộ.'
        },
        {
