...
export default function SEODomainOptimized({
  ...
  description = 'Công cụ tạo dàn đề và thống kê xổ số 3 miền chuyên nghiệp - Thương hiệu Tôn Ngộ Không. Miễn phí, nhanh chóng, chính xác 100%.',
  ...
  return (
    <Head>
      ...
      <meta name="author" content="Dàn Đề Tôn Ngộ Không" />
      ...
      <meta property="og:site_name" content="Tạo Dàn Đề Tôn Ngộ Không" />
