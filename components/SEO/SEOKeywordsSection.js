/**
 * SEO Keywords Section Component
 * Hiển thị keywords cuối trang để tối ưu SEO
 * Lazy loaded để cải thiện hiệu suất trang chủ
 */

import { memo } from 'react';
import styles from './SEOKeywordsSection.module.css';
